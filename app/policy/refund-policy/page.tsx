      ...
      <div className="w-11/12 lg:w-11/12 lg:px-6 m-auto pb-20 mt-20 2xl:w-10/12">
        <section className="">
          ...
          <p className="mt-4 leading-8 2xl:leading-10 lg:leading-10 text-base lg:text-xl 2xl:text-2xl font-creato font-light">
            This terms of use is a legal agreement between you, a user (“You”
            or“Your”), and Blip Limited (“Urban” or “Us” or “Our” or “We”). This
            ...
            Urban mobile application (the "App"). The Terms of Use also govern
            ...
            <Link href={"/assets/policy/RefundPolicy.pdf"} target="_blank">
