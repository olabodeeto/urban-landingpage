...
export default function Navbar() {
  ...
  return (
    <div className="w-full p-4 sticky top-2">
      <div className="w-full lg:w-11/12 m-auto bg-white rounded-lg px-4 py-2 xl:max-w-8xl">
        {/* desktop navbar */}
              ...
              <ul className="flex items-center lg:gap-8 xl:gap-10">
                {tabsData.map((obj, index: number) => (
                  <li
                    ...
                    key={index}
                    className={` cursor-pointer lg:text-base xl:text-base hover:underline hover:text-urban-green ${
