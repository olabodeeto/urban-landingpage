    ...
    <main className="relative ">
      <section className="w-full angecyHero -mt-[7.8rem] 2xl:-mt-40 min-h-[82vh]  bg-agencyHero bg-cover py-10 px-4 flex flex-col items-center">
        <div className="kit-hero-container relative">
          <div className="_leftSide">
            <h2 className="travlerskit-heroText  font-creato font-bold italic">
              Urban Traveler's Kit Store
            </h2>
            <h2 className="travlerskit-heroText font-creato font-light">
      ...
      <div className="2xl:w-11/12 m-auto mt-40 2xl:mt-52">
        ...
        <div className="w-11/12 lg:w-11/12 lg:px-6 m-auto pb-2 mt-20">
          <section className="">
            <h2 className="italic text-4xl lg:text-4xl font-creato font-bold text-urban-green 2xl:text-5xl">
            ...
            <div className="mt-8 2xl:mt-10">
              <button className="py-2 px-6 xl:py-3 xl:px-10 xl:text-xl bg-urban-green text-white font-creato rounded 2xl:text-xl 2xl:py-3 2xl:px-10">
                Shop now
              </button>
            </div>
          </section>
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            ...
            <div className="w-full lg:w-5/12 bg-urban-black p-10 lg:p-20 flex flex-col items-center justify-center gap-4 lg:gap-10 lg:min-h-96">
              ...
              <div className="mt-4 lg:mt-2 w-full">
                <h2 className=" text-2xl lg:text-3xl xl:text-4xl w-10/12 text-white font-creato font-thin italic">
                  Trip <span className="font-bold">Accessories</span>
                </h2>
              </div>
              <p className="mt-4 leading-8 2xl:leading-10 lg:leading-10 text-base lg:text-xl 2xl:text-2xl font-creato font-light text-white">
      ...
      <section className="w-full py-10 lg:py-0 lg:w-8/12 2xl:w-10/12 m-auto xl:mt-20 lg:xl:my-0 lg:pb-20 relative card-slider-section bg-white">
        <div className="minh-96 flex flex-col items-center">
          <div>
            <h2 className="italic text-center text-3xl lg:text-4xl font-creato font-bold text-urban-green 2xl:text-5xl">
              50+ Travel Kits and more{" "}
            </h2>
            <p className="mt-4 text-center w-10/12 xl:w-8/12 m-auto  leading-6 2xl:leading-10 lg:leading-10 text-base lg:text-xl 2xl:text-2xl font-creato font-light">
