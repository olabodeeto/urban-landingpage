        ...
        <div className="w-11/12 lg:w-11/12 lg:px-6 m-auto pb-20 mt-20 2xl:w-10/12">
          <div className="">
            ...
            <p className="mt-4 leading-8 2xl:leading-10 lg:leading-10 text-base lg:text-xl 2xl:text-2xl font-creato font-thin">
              ...
              not only that, the club is a meeting place for like-minded people
              who enjoy unique, luxurious moments together and make friends for
              life in the process. Our tours and events are designed for Urban's
              travelers-however we welcome the participation of like-minded
              travel enthusiasts who want to join us on our tours with their
              family and friends. Just contact us if you are interested and we
              will make you an offer. We look forward to getting to know you.
            </p>
              ...
              <div className="xl:w-10/12 m-auto">
                ...
                <div className="p-4 mt-10 flex flex-col gap-6">
                  <li className="text-xl xl:text-2xl font-light italic">
                    Urban will always take your breath away. Find our next tours
                    and events here and become a part of the ever - growing
                    Urban family.
                  </li>
                  <hr />
                  <li className="text-xl xl:text-2xl font-light italic">
